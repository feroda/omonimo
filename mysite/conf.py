...
BLOG_AUTHOR = "Luca`fero`"  # (translatable)
BLOG_TITLE = "Luca `feroda` Fabriano"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://feroda.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://feroda.org/"
BLOG_EMAIL = "fero@befair.it"
BLOG_DESCRIPTION = "La Mia Saggia Home Page"  # (translatable)
